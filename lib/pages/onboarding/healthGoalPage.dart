...
class _ChoiceTileState extends State<_ChoiceTile> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color fallbackFill =
        isHovered ? AppColors.green.withValues(alpha: 0.08) : Colors.white;

    final Color borderColor = selected
        ? AppColors.green
        : (isHovered ? AppColors.greenLight : const Color(0xFFA9ABAD));

    final Color textColor = selected ? Colors.white : AppColors.lightGreyText;
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            gradient: gradient,
            color: widget.enabled ? null : Colors.grey[100]!,
