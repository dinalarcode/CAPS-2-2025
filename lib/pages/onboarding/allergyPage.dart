...
class _AllergyPageState extends State<AllergyPage> {
  ...
  // Daftar Opsi Alergi dengan placeholder gambar (gunakan assets/images/allergies/ di proyek Anda)
  final List<Map<String, String>> allergyOptions = [
    {'name': 'Tidak Ada Alergi', 'image': 'assets/images/allergies/No_Allergy.png'}, // Opsi tanpa alergi
    {'name': 'Seafood', 'image': 'assets/images/allergies/Seafood.png'},
    {'name': 'Ikan', 'image': 'assets/images/allergies/Fish.png'},
    {'name': 'Udang', 'image': 'assets/images/allergies/Shrimp.png'},
    {'name': 'Sapi', 'image': 'assets/images/allergies/Beef.png'},
    {'name': 'Ayam', 'image': 'assets/images/allergies/Chicken.png'},
  ];
