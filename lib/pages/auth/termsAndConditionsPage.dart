            ...
            return Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        icon: const Icon(Icons.close, color: AppColors.black87, size: 24),
                ...
                Positioned(
                  ...
                  height: fh(125.66),
                  child: Image.asset(
                    'assets/images/illustrations/Data Privacy Illustration.png',
                    fit: BoxFit.contain,
                  ),
                ),
                ...
                Positioned(
                  ...
                  child: GradientHoverButton(
                    ...
                    idleBorderColor: AppColors.disabledGrey,
                    idleFillColor: AppColors.white,
                    idleTextColor: AppColors.black,
                    activeGradientColors: const [AppColors.greenLight, AppColors.green],
...
class GradientHoverButton extends StatefulWidget {
  ...
  const GradientHoverButton({
    ...
    this.idleBorderColor = AppColors.disabledGrey,
    this.idleFillColor = AppColors.white,
    this.idleTextColor = AppColors.black,
    this.activeGradientColors = const [AppColors.greenLight, AppColors.green],
